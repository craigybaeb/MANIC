...
class Utility:
    def __init__(self, data_instance, categories, immutable_features, target_class, verbose, predict_fn, disagreement, base_counterfactuals, evaluation):
    ...
    def print_results(self, best_counterfactual, best_fitness, num_generations, generation_found, time_taken, time_found):
        ...
        if best_counterfactual is not None:
            proximity_score = self.disagreement.calculate_proximity(self.data_instance, best_counterfactual)
